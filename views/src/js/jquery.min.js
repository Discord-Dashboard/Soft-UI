!(function (e, t) {
    ...
    function He(e, t, n, r) {
        ...
        if (
            ...
            if (u)
                for (
                    c = s[s.length - 1].ownerDocument, b.map(s, qe), f = 0;
                    f < u;
                    f++
                )
                    (l = s[f]),
                    ...
                    i ||
                        ...
                        (l &&
                            ...
                            t.isPropagationStopped() &&
                                d.addEventListener(m, yt),
                            r[m](),
                            t.isPropagationStopped() &&
                                d.removeEventListener(m, yt),
