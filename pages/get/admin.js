...
module.exports = {
    ...
    execute: async (req, res, app, config, themeConfig, info) => {
        ...
        if (!pterodactyl && themeConfig.admin.pterodactyl.enabled) return res.send("Unable to contact Pterodactyl, are your details correct?");
        ...
        if (db.get('feeds.one') && db.get('feeds.two') && db.get('feeds.three')) allFeedsUsed = true;
